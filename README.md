...
- **Interactive Risk Mapping**: Real-time geospatial tracking of 250+ MSME units across high-risk clusters (Morbi, Bhiwandi, Ludhiana) overlaid with dealer stock levels.
...
- **District Official Dashboard**: Provides governance bodies (DICs) with daily "Morning Reports" on which factories face imminent shutdown risk.
